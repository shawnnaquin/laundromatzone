...
function themify_theme_page_meta_box( $args = array() ){
	...
	return array(
		...
		array(
			...
			'default' => 'no',
			'hide'		=> 'no section-scrolling-mobile section-scrolling-direction section-scrolling-style'
		),
		...
		array(
			'name' 		=> 'fullpage_parallax_scrolling',
			'title'		=> '',
			'after'		=> __(' Enable parallax scrolling', 'themify'),
			'type' 		=> 'checkbox',
			'default' 	=> 'default',
			'class'		=> 'fullpage_parallax_scrolling',
		),
	);
}
