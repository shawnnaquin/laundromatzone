...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'site-logo_image' => array(
			...
			'selector' => 'body[class*="themify"] #site-logo',
			'prop' => 'logo',
		),
		...
		'mobile_menu_icon_background' => array(
			...
			'selector' => '.mobile_menu_active.header-leftpane #pagewrap #headerwrap .header-icons #menu-icon, .mobile_menu_active.header-rightpane #pagewrap #headerwrap .header-icons #menu-icon, body:not(.header-leftpane):not(.header-rightpane).mobile_menu_active #menu-icon',
			'prop' => 'background',
			'global' => true,
		),
		...
		'mobile_menu_icon_color' => array(
			...
			'selector' => '.mobile_menu_active.header-leftpane #pagewrap #headerwrap .header-icons #menu-icon, .mobile_menu_active.header-rightpane #pagewrap #headerwrap .header-icons #menu-icon, #headerwrap #menu-icon',
			'prop' => 'color',
			'global' => true,
		),
