...
a)}});c.Collections.Rows=Backbone.Collection.extend({model:c.Models.Row});c.Models.Registry={items:{},register:function(a,b){this.items[a]=b},lookup:function(a){return this.items[a]||null},remove:function(a){delete this.items[a]},destroy:function(){_.each(this.items,function(a,b){a.destroy()});this.items={}}};c.Models.setValue=function(a,b,d){d=d||!1;c.Models.Registry.lookup(a).set(b,{silent:d})};c.vent=_.extend({},Backbone.Events);c.Views.register_module=function(a,b){"default"!==a&&(this.Modules[a]=
this.Modules["default"].extend(b))};c.Views.init_module=function(a,b){if(void 0===themifyBuilder.modules[a.mod_name])return!1;b=b||"default";void 0===a.mod_settings&&void 0!==themifyBuilder.modules[a.mod_name].defaults&&(a.mod_settings=_.extend({},themifyBuilder.modules[a.mod_name].defaults));var d=a instanceof c.Models.Module?a:new c.Models.Module(a),g=new (this.get_module(b))({model:d,type:b});return{model:d,view:g}};c.Views.get_module=function(a){a=a||"default";return this.module_exists(a)?this.Modules[a]:
this.Modules["default"]};c.Views.unregister_module=function(a){"default"!==a&&this.module_exists(a)&&delete this.Modules[a]};c.Views.module_exists=function(a){return this.Modules.hasOwnProperty(a)};c.Views.register_column=function(a,b){"default"!==a&&(this.Columns[a]=this.Columns["default"].extend(b))};c.Views.init_column=function(a,b){b=b||"default";var d=a instanceof c.Models.Column?a:new c.Models.Column(a),g=new (this.get_column(b))({model:d,type:b});return{model:d,view:g}};c.Views.get_column=
function(a){a=a||"default";return this.column_exists(a)?this.Columns[a]:this.Columns["default"]};c.Views.unregister_column=function(a){"default"!==a&&this.column_exists(a)&&delete this.Columns[a]};c.Views.column_exists=function(a){return this.Columns.hasOwnProperty(a)};c.Views.register_subrow=function(a,b){"default"!==a&&(this.SubRows[a]=this.SubRows["default"].extend(b))};c.Views.init_subrow=function(a,b){b=b||"default";var d=a instanceof c.Models.SubRow?a:new c.Models.SubRow(a),g=new (this.get_subrow(b))({model:d,
type:b});return{model:d,view:g}};c.Views.get_subrow=function(a){a=a||"default";return this.subrow_exists(a)?this.SubRows[a]:this.SubRows["default"]};c.Views.unregister_subrow=function(a){"default"!==a&&this.subrow_exists(a)&&delete this.SubRows[a]};c.Views.subrow_exists=function(a){return this.SubRows.hasOwnProperty(a)};c.Views.register_row=function(a,b){"default"!==a&&(this.Rows[a]=this.Rows["default"].extend(b))};c.Views.init_row=function(a,b){var d=a.attributes;if(void 0===d||void 0!==d.cols&&
(0<Object.keys(d.cols)||0<d.cols.length)||void 0!==d.styling&&0<Object.keys(d.styling).length){b=b||"default";var d=a instanceof c.Models.Row?a:new c.Models.Row(a),g=new (this.get_row(b))({model:d,type:b});return{model:d,view:g}}return!1};c.Views.get_row=function(a){a=a||"default";return this.row_exists(a)?this.Rows[a]:this.Rows["default"]};c.Views.unregister_row=function(a){"default"!==a&&this.row_exists(a)&&delete this.Rows[a]};c.Views.row_exists=function(a){return this.Rows.hasOwnProperty(a)};
c.Views.BaseElement=Backbone.View.extend({type:"default",events:{"click .themify_builder_copy_component":"copy","click .themify_builder_paste_component":"paste","click .themify_builder_import_component":"import","click .themify_builder_export_component":"export","click .themify_builder_save_component":"save","click .themify_duplicate":"duplicate","click .themify_delete":"delete"},initialize:function(a){_.extend(this,_.pick(a,"type"));this.listenTo(this.model,"custom:change",this.modelChange);this.listenTo(this.model,
"destroy",this.remove)},modelChange:function(){this.$el.attr(_.extend({},_.result(this,"attributes")));var a=this.render();this.model.get("elType");var b=c.beforeEvent.data("cid");e(".tb_element_cid_"+b).replaceWith(a.el);"visual"===c.mode?this.model.trigger("visual:change"):("row"===c.eventName&&(b=this.$el.data("cid")),c.vent.trigger("dom:change",b,c.beforeEvent,this.$el,c.eventName),c.Mixins.Builder.update(this.$el),"row"===c.eventName&&c.vent.trigger("dom:builder:change"))},remove:function(){this.$el.remove()},
copy:function(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget);a=ThemifyBuilderCommon.detectBuilderComponent(b);switch(a){case "row":case "subrow":var c=b.closest(".module_"+a);break;case "module":c=b.closest(".active_module");break;case "column":case "sub-column":c=b.closest(".module_column")}c=this.getData(c,a);"sub-column"===a&&(c.component_name=a);ThemifyBuilderCommon.Clipboard.set(a,c)},paste:function(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget),d=ThemifyBuilderCommon.detectBuilderComponent(b);
a=ThemifyBuilderCommon.Clipboard.get(d);if(!1===a)ThemifyBuilderCommon.alertWrongPaste();else if(ThemifyBuilderCommon.confirmDataPaste()){var b=b.closest("[data-cid]"),g=c.Models.Registry.lookup(b.data("cid"));c.eventName="row";if("column"===d||"sub-column"===d)a.grid_class=c.Utils.filterClass(b.prop("class")),b.hasClass("first")?a.grid_class+=" first":b.hasClass("last")&&(a.grid_class+=" last"),(d=b[0].style.width)?a.grid_width=d.replace("%",""):delete a.grid_width;c.beforeEvent=ThemifyBuilderCommon.Lightbox.clone(b);
g.setData(a)}},"import":function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var b=ThemifyBuilderCommon.detectBuilderComponent(a),d=a.closest("[data-cid]"),g=c.Models.Registry.lookup(d.data("cid")),f={data:{action:"tb_component_data",component:b,type:"import"}};if("column"===b||"sub-column"===b){var h=a.closest(".module_column");var k=h.closest("column"===b?".module_row":".module_subrow").index();f.data.indexData={row:k,col:h.index()}}ThemifyBuilderCommon.Lightbox.open(f,null,function(){var a=
this.$lightbox;a.find("#builder_submit_import_component_form").on("click",function(f){f.preventDefault();f=a.find("#tb_data_field");f=JSON.parse(f.val());if("column"===b&&"sub-column"===f.component_name||"sub-column"===b&&"column"===f.component_name)f.component_name=b;if(void 0===f.component_name||f.component_name!==b)ThemifyBuilderCommon.alertWrongPaste();else{f=c.Utils.clear(f,!0);if("column"===b||"sub-column"===b)f.column_order=h.index(),f.grid_class=h.prop("class"),"column"===b?f.row_order=k:
(f.sub_row_order=k,f.row_order=h.closest(".module_row").index(),f.col_order=h.parents(".module_column").index());c.eventName="row";c.beforeEvent=ThemifyBuilderCommon.Lightbox.clone(d);g.setData(f);ThemifyBuilderCommon.Lightbox.close()}})})},getData:function(a,b){var d={};var g=b||ThemifyBuilderCommon.detectBuilderComponent(a);switch(g){case "row":case "subrow":var f=a.closest(".module_"+g);var e=f.index();d=c.Utils._getRowSettings(f[0],e,g);break;case "module":d=c.Models.Registry.lookup(a.closest(".active_module").data("cid")).attributes;
d=c.Utils.clear(d,!0);break;case "column":case "sub-column":d=a.closest(".module_column"),f=d.closest("column"===g?".module_row":".module_subrow"),e=f.index(),g=c.Utils._getRowSettings(f[0],e,"column"===g?"row":"subrow"),d=g.cols[d.index()]}return d},"export":function(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget);a=ThemifyBuilderCommon.detectBuilderComponent(b);var c=this.getData(b,a),b={data:{action:"tb_component_data",component:a,type:"export"}};c.component_name=a;c=JSON.stringify(c);
ThemifyBuilderCommon.Lightbox.open(b,null,function(){this.$lightbox.find("#tb_data_field").val(c).on("click",function(){e(this).trigger("focus").trigger("select")})})},duplicate:function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget).closest("[data-cid]");var b=ThemifyBuilderCommon.Lightbox.clone(a),d=c.Models.Registry.lookup(b.data("cid"));a.removeClass("tb_element_cid_"+d.cid);b.hide().insertAfter(a);var g="module"===d.get("elType")?"mod_settings":"styling",f=this.getData(b,d.get("elType"));
if(ThemifyBuilderCommon.Lightbox.$lightbox.is(":visible")&&c.activeModel.cid==d.cid){var h=c.Forms.serialize("themify_builder_options_setting"),k=c.Forms.serialize("themify_builder_options_animation"),l=c.Forms.serialize("themify_builder_options_visibility"),m=e.extend(!0,{},c.Mixins.Common.styleData),m=c.Forms.serialize("themify_builder_options_styling",m),m=c.Utils.clear(m,!0),h=e.extend(!0,m,h,k,l),h=c.Utils.clear(h);f[g]=h}c.eventName="duplicate";c.beforeEvent=b;d.setData(f);a.addClass("tb_element_cid_"+
d.cid)},editComponent:function(){c.hasChanged=!1;if(c.autoSaveCid!==c.activeModel.cid){var a=c.activeModel.get("elType"),b="module"===a?c.activeModel.get("mod_name"):a;ThemifyBuilderCommon.Lightbox.open({loadMethod:"inline",templateID:"builder_form_"+b},function(b){c.Mixins.Common.editComponentCallback(b,a,!1,!1)},function(b){b=ThemifyBuilderCommon.Lightbox.$lightbox;c.activeModel.get("styleClicked")?b.find('a[href="#themify_builder_options_styling"]').trigger("click"):c.activeModel.get("visibileClicked")?
b.find('a[href="#themify_builder_options_visibility"]').trigger("click"):new SimpleBar(b.find("#"+("column"===a||"subrow"===a?"themify_builder_options_styling":"themify_builder_options_setting"))[0]);c.autoSaveCid=c.activeModel.cid})}},"delete":function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var b=ThemifyBuilderCommon.detectBuilderComponent(a);if(confirm(themifyBuilder.i18n[b+"DeleteConfirm"])){var d=a.closest("[data-cid]");a=d.data("cid");if(b=c.Models.Registry.lookup(a)){var d=
d.closest(".module_row"),g="row",f="",h={};"row"===b.get("elType")?(h.pos_cid=d.next(".module_row"),h.pos="before",0===h.pos_cid.length&&(h.pos="after",h.pos_cid=d.prev(".module_row")),g="delete_row",h.pos_cid=h.pos_cid.data("cid")):a=d.data("cid");d=ThemifyBuilderCommon.Lightbox.clone(d);b.destroy();"row"!==b.get("elType")?f=e(".tb_element_cid_"+a):c.vent.trigger("dom:builder:change");c.vent.trigger("dom:change",a,d,f,g,h)}}},save:function(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget);
a=ThemifyBuilderCommon.detectBuilderComponent(b);switch(a){case "row":var d=b.closest(".module_"+a).get(0);d=c.Utils._getRowSettings(d,0);break;case "module":d=b.closest(".active_module"),d=c.Models.Registry.lookup(d.data("cid")),d={mod_name:d.get("mod_name"),mod_settings:d.get("mod_settings")}}a={data:{action:"tb_library_item_form",postid:themifyBuilder.post_ID,model:this.model.cid,item:JSON.stringify(d),type:a}};ThemifyBuilderCommon.Lightbox.open(a)}});c.Views.BaseElement.extend=function(a){var b=
this,c=Backbone.View.extend.apply(this,arguments);c.prototype.events=_.extend({},this.prototype.events,a.events);c.prototype.initialize=function(){_.isFunction(b.prototype.initialize)&&b.prototype.initialize.apply(this,arguments);_.isFunction(a.initialize)&&a.initialize.apply(this,arguments)};return c};c.Views.Modules["default"]=c.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"themify_builder_module module-"+this.model.get("mod_name")+" active_module tb_element_cid_"+
this.model.cid,"data-cid":this.model.cid}},template:wp.template("builder_module_item"),events:{dblclick:"edit","click .themify_module_options":"edit","click .themify_builder_module_styling":"edit","click .tb_visibility_component ":"edit","click .themify_module_swap":"swap"},initialize:function(){this.listenTo(this,"edit",this.edit);this.listenTo(this,"swap",this.swap);this.listenTo(this.model,"dom:module:unsaved",this.removeUnsaved);this.listenTo(this.model,"change:view",this.setView)},removeUnsaved:function(){this.model.destroy()},
render:function(){this.el.innerHTML=this.template(this.model.toRenderData());"layout-part"==this.model.get("mod_name")&&("visual"==this.type?e('<li><a href="#" class="themify_module_swap ti-reload themify-tooltip-bottom">Swap<span class="themify_tooltip">Swap</span></a></li>').insertBefore(this.$el.find(".themify_module_options").parent()):e('<li><a href="#" class="themify_module_swap ti-reload" >Swap</a></li>').insertBefore(this.$el.find(".themify_module_options").parent()));ThemifyBuilderCommon.inLightboxIframe()&&
(this.$el.find("a.themify_builder_save_component").remove(),"layout-part"==this.model.get("mod_name")&&this.$el.find("a.themify_module_options").remove());"layout-part"==this.model.get("mod_name")&&this.$el.find("a.themify_builder_save_component").remove();return this},setView:function(a){this.setElement(a)},edit:function(a){if(c.isPreview)return!0;"layout-part"==this.model.get("mod_name")&&a&&("dblclick"==a.type||e(a.target).hasClass("themify_module_options"))?this.swap(a):(null!==a&&(a.preventDefault(),
a.stopPropagation(),a.currentTarget.classList.contains("themify_builder_module_styling")?this.model.set({styleClicked:!0},{silent:!0}):a.currentTarget.classList.contains("tb_visibility_component")&&this.model.set({visibileClicked:!0},{silent:!0})),c.activeModel&&void 0!==c.activeModel.get("is_new")&&c.activeModel.unset("is_new",{silent:!0}),this.model.cid!==c.autoSaveCid&&null!==c.autoSaveCid&&c.Forms.saveComponent(null),c.activeModel=this.model,this.editComponent())},swap:function(a){if("layout-part"==
this.model.get("mod_name")){if(!_.isNull(a)&&!_.isUndefined(a)&&(a.preventDefault(),e(a.target).hasClass("themify_module_swap"))){this.edit(a);return}c.activeModel=this.model;var b=this;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_layout_part_swap",nonce:themifyBuilder.tb_load_nonce,slug:this.model.get("mod_settings").selected_layout_part,page:!1},success:function(a){if(a){window.highest_iframe=window.highest_iframe?window.highest_iframe:window.top.document;a="string"===typeof a?
JSON.parse(a):a;highest_iframe.layoutpart={margin:"",overlay:"",model:function(){if("visual"==b.type){var a=c.Models.Registry.items,d=b.model.get("mod_settings"),g;for(g in a)if("module"==a[g].get("elType")&&"layout-part"==a[g].get("mod_name")&&d.selected_layout_part==a[g].get("mod_settings").selected_layout_part){var e=a[g].get("mod_settings");e.unsetKey=!0;a[g].trigger("custom:preview:refresh",e)}}}};var d=wp.template("builder_layoutpart_lightbox")({link:a.url});a=e("body").append('<div class="themify_builder_overlay_2" style="position: fixed; width: 100%; height: 100%; top: 0; left: 0; bottom: 0; right: 0; z-index: 9990; overflow: hidden;">&nbsp;</div>').children(".themify_builder_overlay_2")[0];
...
p?(p=p.prop("id"),D=tinyMCE.get(p),p=_.isNull(D)||!1!==D.hidden?switchEditors.wpautop(tinymce.DOM.get(p).value):D.getContent(),v.val(p)):v.val("");h.push(v)}else if(x.contains("themify-layout-icon"))D=v.find("a"),D.removeClass("selected"),p?D.filter("#"+p.find(".selected").prop("id")).addClass("selected"):(p=themifyBuilder.modules[c.activeModel.get("mod_name")],void 0!==p&&void 0!==p.defaults&&p.defaults[u]?D.filter("#"+p.defaults[u]).addClass("selected"):D.first().addClass("selected"));else if(x.contains("themify-builder-uploader-input"))m&&
...
themifyBuilder.post_ID);ThemifyBuilderCommon.Lightbox.close()}})},{buttons:{no:{label:"Replace Existing Builder"},yes:{label:"Append Existing Builder"}}})},lightbox_switcher:function(a){a.preventDefault();a=e(a.currentTarget).attr("href").replace("#","");c.activeModel&&"visual"===c.mode&&(c.scrollTo=c.liveStylingInstance.$liveStyledElmt);e(".tb_breakpoint_switcher.breakpoint-"+a,top_iframe).trigger("click")},reLoad:function(a,b){function d(){"visual"===c.mode?(c.Utils.loadContentJs(),c.id=!1):c.hasChanged=
!0;c.vent.trigger("dom:builder:init");ThemifyBuilderCommon.showLoader("hide");"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(e("body",top_iframe).height(document.body.scrollHeight),setTimeout(function(){e("body",top_iframe).height(document.body.scrollHeight)},2E3))}c.Models.Registry.destroy();c.Instances.Builder={};var g="";if("visual"===c.mode){var f="themify-builder-"+b+"-generated-css",h=e("link#"+f),g="#themify_builder_content-"+b;c.id=b;h.remove();void 0!==a.css&&void 0!==a.css.css_file&&
(f="<link id="+f+' type="text/css" rel="stylesheet" href="'+a.css.css_file+"?tmp="+Date.now()+'" />',document.getElementById("themify-builder-admin-ui-css").insertAdjacentHTML("afterend",f));c.VisualCache=[];c.editing=!1;c.isComponentSaved=[];setTimeout(function(){c.liveStylingInstance.reset()},1);e("body").addClass("sidebar-none full_width")}else g="#themify_builder_row_wrapper";c.Instances.Builder[0]=new c.Views.Builder({el:g,collection:new c.Collections.Rows(a.builder_data),type:"visual"});c.Instances.Builder[0].render();
c.toolbar.undoManager.reset();"visual"===c.mode?c.bootstrap(null,d):d()},templateSelected:function(a){a.preventDefault();a.stopPropagation();var b=e(this).closest(".layout_preview");ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.confirm_template_selected,function(a){var d=themifyBuilder.post_ID,f={type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_set_layout",mode:"no"===a?1:0,nonce:themifyBuilder.tb_load_nonce,layout_slug:b.data("slug"),id:d,layout_group:b.data("group")},
beforeSend:function(){"visual"===c.mode&&ThemifyBuilderCommon.showLoader("show")},success:function(a){ThemifyBuilderCommon.Lightbox.close();"success"===a.status?c.Forms.reLoad(a,d):(ThemifyBuilderCommon.showLoader("error"),alert(a.msg))}};if("pre-designed"===b.data("group")){ThemifyBuilderCommon.showLoader("show");var h=b.data("slug"),k="https://themify.me/themify-layouts/"+h+".txt",l=function(){f.data.builder_data=c.layouts_selected[h];e.ajax(f)};if(!c.layouts_selected)c.layouts_selected={};else if(c.layouts_selected[h]){l();
return}e.get(k,null,null,"text").done(function(a){c.layouts_selected[h]=a;l()}).fail(function(a,b,c){ThemifyBuilderCommon.LiteLightbox.alert("There was an error in loading layout, please try again later, or you can download this file: ("+k+") and then import manually (http://themify.me/docs/builder#import-export).")}).always(function(){ThemifyBuilderCommon.showLoader()})}else e.ajax(f)},{buttons:{no:{label:"Replace Existing Layout"},yes:{label:"Append Existing Layout"}}})},saveAsLayout:function(a){a.preventDefault();
...
e("body",highest_iframe).removeClass("themify_builder_layoutPart_edit"),e("#tb_toolbar",highest_iframe).show(),highest_iframe.layoutpart.model()),e(window.highest_iframe.layoutpart.overlay).css({backgroundColor:"initial"}).hide().siblings(".tb_layoutpart_lightbox").remove(),e(window.highest_iframe.layoutpart.overlay).remove()):window.parent.location.reload(!0)},undoManager:{stack:[],is_working:!1,index:-1,btnUndo:null,btnRedo:null,init:function(){var a=this;this.btnUndo=window.parent.document.getElementsByClassName("tb-undo-btn")[0];
this.btnRedo=window.parent.document.getElementsByClassName("tb-redo-btn")[0];c.toolbar.$el.find(".tb-undo-redo").on("click",this.do_change.bind(this));if(!themifyBuilder.disableShortcuts&&(e(top_iframe).on("keydown",this.keypres.bind(this)),"visual"===c.mode))e(document).on("keydown",this.keypres.bind(this));c.vent.on("dom:change",function(b,d,g,f,h){c.hasChanged&&(c.editing=!1,g&&(g=ThemifyBuilderCommon.Lightbox.clone(g)),"visual"!==c.mode||"duplicate"!==f&&"sort"!==f||e(window).trigger("tfsmartresize.tfVideo"),
a.stack.splice(a.index+1,a.stack.length-a.index),a.stack.push({cid:b,type:f,data:h,before:d,after:g}),a.index=a.stack.length-1,a.updateUndoBtns(),"visual"===c.mode&&e("body").trigger("builder_dom_changed",[f]))})},set:function(a){var b=a[0].querySelectorAll("[data-cid]"),b=Array.prototype.slice.call(b);b.unshift(a[0]);a=0;for(var d=b.length;a<d;++a){var e=c.Models.Registry.lookup(b[a].getAttribute("data-cid"));e&&e.trigger("change:view",b[a])}},doScroll:function(a){("visual"!==c.mode||"desktop"===
c.activeBreakPoint?e("body"):e("body",top_iframe)).scrollTop(a.offset().top)},keypres:function(a){if(90===a.which&&"INPUT"!==document.activeElement.tagName&&"TEXTAREA"!==document.activeElement.tagName)if(!0===a.ctrlKey&&!0===a.shiftKey||!0===a.metaKey&&!0===a.shiftKey)a.preventDefault(),this.hasRedo()&&this.changes(!1);else if(!0===a.ctrlKey||!0===a.metaKey)a.preventDefault(),this.hasUndo()&&this.changes(!0)},changes:function(a){var b=this.stack[this.index+(a?0:1)];if(void 0!==b){this.is_working=
!0;var d="";var g=b.type,f=e(".tb_element_cid_"+b.cid);var h=!1;if("row"===g)a?(d=b.before.clone(!0),h=b.cid):(d=b.after.clone(!0),h=b.before.data("cid"),f=e(".tb_element_cid_"+h)),this.set(d),f.replaceWith(d);else if("duplicate"===g)a?e(".tb_element_cid_"+b.after.data("cid")).remove():(d=b.after.clone(!0),h=b.before.data("cid"),this.set(d),f.after(d));else if("delete_row"===g)a?(d=b.before.clone(!0),h=b.cid,f=e(".tb_element_cid_"+b.data.pos_cid),this.set(d),"after"===b.data.pos?f.after(d):f.before(d)):
f.remove();else if("sort"===g)h=b.cid,a?(f=b.data.after,g=b.data.before,d=b.before.clone(!0)):(f=b.data.before,g=b.data.after,d=b.after.clone(!0),"visual"===c.mode&&d.find(".active_module").css({display:"block",height:"auto"})),this.set(d),e(".tb_element_cid_"+f).find(".tb_element_cid_"+h).remove(),e(".tb_element_cid_"+g).replaceWith(d);else if("save"===g){h=b.cid;var g=c.Models.Registry.lookup(h),k="module"===g.get("elType"),l={},m=k?"mod_settings":"styling";k&&b.data.column?a?(h=!1,f.remove()):
(h=b.data.column.data("cid"),d=b.data.column.clone(!0),f=e(".tb_element_cid_"+h),this.set(d),f.replaceWith(d)):(a?(l[m]=b.data.old,d=b.before.clone(!0)):(l[m]=b.data["new"],d=b.after.clone(!0)),g.set(l,{silent:!0}),this.set(d),f.replaceWith(d),"visual"===c.mode&&c.liveStylingInstance.doUndo(b.data.styles,a?b.data.first:!1))}else if("predesign"===g)if(f=b.data.rows,a)for(g=0,k=f.length;g<k;++g)e(".tb_element_cid_"+f[g].data("cid")).remove();else{l=document.createDocumentFragment();d=[];g=0;for(k=f.length;g<
...
this.index++;this.is_working=!1;this.updateUndoBtns()}},hasRedo:function(){return this.index<this.stack.length-1},hasUndo:function(){return-1!==this.index},disable:function(){this.btnUndo||(this.btnUndo=window.parent.document.getElementsByClassName("tb-undo-btn")[0]);this.btnRedo||(this.btnRedo=window.parent.document.getElementsByClassName("tb-redo-btn")[0]);this.btnUndo.classList.add("tb_disabled");this.btnRedo.classList.add("tb_disabled");this.btnUndo.parentNode.classList.contains("tb_toolbar_compact_item")&&
...
e("<div/>").html(a).text())})}a.preventDefault();var d=this;confirm(themifyBuilder.i18n.confirm_on_duplicate_page)&&c.Utils.saveBuilder(b)},Revisions:{init:function(){c.toolbar.$el.find(".tb_revision").on("click",this.revision.bind(this));e("body",top_iframe).on("click",".js-builder-restore-revision-btn",this.restore.bind(this)).on("click",".js-builder-delete-revision-btn",this["delete"].bind(this))},revision:function(a){a.preventDefault();a.currentTarget.classList.contains("tb_save_revision")?this.save():
this.load()},load:function(){ThemifyBuilderCommon.Lightbox.open({data:{action:"tb_load_revision_lists",postid:themifyBuilder.post_ID,tb_load_nonce:themifyBuilder.tb_load_nonce}})},ajax:function(a,b){a=e.extend({},a,{tb_load_nonce:themifyBuilder.tb_load_nonce,postid:themifyBuilder.post_ID});return e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:a,beforeSend:function(){ThemifyBuilderCommon.showLoader("show")},complete:function(){ThemifyBuilderCommon.showLoader("hide")},success:function(a){e.isFunction(b)&&
...
a.stopPropagation();var b=0<e(a.currentTarget).closest(".tb_toolbar_backend_edit").length?e(a.currentTarget).prop("href"):!1;themifyBuilder.is_gutenberg_editor&&!1!==b?(c.toolbar.undoManager.reset(),c._backendSwitchFrontend(b)):c.Utils.saveBuilder(function(a,e){"success"!==e?alert(themifyBuilder.i18n.errorSaveBuilder):!1!==b&&("visual"===c.mode?(sessionStorage.setItem("focusBackendEditor",!0),window.parent.location.href=b):(c.toolbar.undoManager.reset(),c._backendSwitchFrontend(b)))})},libraryItems:{is_init:null,
items:[],subTab_toolbar:null,init:function(){e(document).on("change:tab:tb_module_panel_library_wrap",this.load.bind(this));c.toolbar.common.subTab_btn=this.subTab_toolbar=c.toolbar.$el.find("ul.tb_library_types li.active a").data("type")},get:function(a,b){return _.isUndefined(this.items[b])||this.items[b].type!=a?!1:this.items[b].data},load:function(a,b,d){if(!this.is_init){b=e(b);var g=this;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,
pid:themifyBuilder.post_ID},beforeSend:function(a){b.addClass("tb_busy")},success:function(a){g.setData(g.subTab_toolbar,a,b,d);b.removeClass("tb_busy")},error:function(){b.removeClass("tb_busy");ThemifyBuilderCommon.showLoader("error");this.is_init=!1;c.toolbar.$el.find(".tb_library_item_list").html("<h3>Failed to load Library Items.</h3>")}})}},setData:function(a,b,d,g){if(!this.is_init){a='<span id="no-content" style="display:none">No library content found.</span>';d=c.toolbar.$el.find(".tb_library_item_list");
b="string"===typeof b?JSON.parse(b):b;if("object"===typeof b||"array"===typeof b){this.items=[];for(var f=0,h=b.length;f<h;++f)this.items.push({type:b[f].type,data:b[f]}),a+='<div class="dragable_library_item dragable_library_item_'+b[f].type+'" data-id="'+f+'" data-type="library_item" data-main="'+b[f].type+'">',a+='<div class="dragable_library_item_inner"><span>'+b[f].title+"</span>",a+='<a href="#" class="remove_item_btn" title="Delete" ondragstart="return false;"></a></div></div>'}d[0].innerHTML=
a;new SimpleBar(d[0]);this.set_subTab();this.change(this.subTab_toolbar,c.toolbar.$el);e(document).trigger("update:tb_btn","tb_module_panel_library_wrap",g);this.is_init=!0;c.toolbar.common.library_load=!0}},change:function(a,b){b.find(".dragable_library_item, #no-content").hide();0<b.find(".dragable_library_item_"+a).length?b.find(".dragable_library_item_"+a).show():b.find("#no-content").show()},set_subTab:function(a){function b(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget),
d=b.data("type"),f=b.closest("#tb_plus_btn_popover.tb_modules_panel_wrap");0>=f.length&&(f=e(a.target,top_iframe).closest("#tb_module_panel.tb_modules_panel_wrap"));f.find(".tb_module_panel_search_text").val("");b.closest("li").addClass("active").siblings().removeClass("active");"tb_module_panel"===f.prop("id")?g.subTab_toolbar=d:c.toolbar.common.subTab_btn=d;g.is_init?g.change(d,f):e(document).trigger("change:tab:tb_module_panel_library_wrap",f)}function d(a){g["delete"](a,g)}var g=this;"btn"==a?
(c.toolbar.common.btn.find(".tb_library_types").off("click","a").on("click","a",b.bind(this)),c.toolbar.common.btn.find("a.remove_item_btn").off("click").on("click",d.bind(this))):(c.toolbar.$el.find(".tb_library_types").off("click","a").on("click","a",b.bind(this)),c.toolbar.$el.find("a.remove_item_btn").off("click").on("click",d.bind(this)))},"delete":function(a,b){a.preventDefault();a.stopPropagation();var d=e(a.target).closest(".dragable_library_item"),g=b.items[d.data("id")].type,f=e(a.target).closest("#tb_plus_btn_popover.tb_modules_panel_wrap");
0>=f.length&&(f=e(a.target,top_iframe).closest("#tb_module_panel.tb_modules_panel_wrap"));b.items&&!_.isUndefined(b.items[d.data("id")])&&confirm(themifyBuilder.i18n[g+"LibraryDeleteConfirm"])&&e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_remove_library_item",nonce:themifyBuilder.tb_load_nonce,pid:b.items[d.data("id")].data.pid},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(a){b.is_init=!1;if(!_.isUndefined(a.opt)){var d=e("#tmpl-builder_form_layout-part"),
g=e("<div />").html(d.html());g.find("#selected_layout_part").html(a.opt);d[0].innerHTML=g.html();var d=c.Models.Registry.items,h;for(h in d)"module"==d[h].get("elType")&&"layout-part"==d[h].get("mod_name")&&a.part==d[h].get("mod_settings").selected_layout_part&&d[h].destroy()}ThemifyBuilderCommon.showLoader("hide");c.toolbar.$el.find(".tb_library_item_list").empty();e(document).trigger("change:tab:tb_module_panel_library_wrap",f)},error:function(){ThemifyBuilderCommon.showLoader("error")}})}},preDesignedRows:{is_init:null,
rows:{},filter_toolbar:null,init:function(){setTimeout(function(){document.getElementsByTagName("head")[0].insertAdjacentHTML("afterbegin",'<meta http-equiv="x-dns-prefetch-control" content="on"/><link href="//themify.me" rel="dns-prefetch preconnect"/><link href="//fonts.googleapis.com" rel="dns-prefetch"/><link href="//maps.google.com" rel="dns-prefetch"/><link href="https://themify.me/public-api/predesigned-rows/index.json" rel="prefetch"/>')},7E3);e(document).on("tb_setpredesignedrows",this.get.bind(this));
e(document).on("tb_setpremaderows",this.grid.bind(this));e(document).on("change:tab:tb_module_panel_rows_wrap",this.load.bind(this))},load:function(a,b,d){if(null===this.is_init){this.is_init=!0;var g=this;b=e(b);b.addClass("tb_busy");e.getJSON("https://themify.me/public-api/predesigned-rows/index.json").done(function(a){g.setData(a,b,d)}).fail(function(a,e,k){g.setData({},b,d);this.is_init=null;ThemifyBuilderCommon.showLoader("error");c.toolbar.$el.find(".tb_predesigned_rows_list").append("<h3>Failed to load Pre-Designed Rows from server.</h3>")})}},
setData:function(a,b,d){function g(){x.filter();b.removeClass("tb_busy");new SimpleBar(p[0]);e(document).trigger("update:tb_btn","tb_module_panel_rows_wrap",d);c.toolbar.common.preDesign_load=!0}for(var f=[],h="",k="",l=0,m=a.length;l<m;++l){for(var q=a[l].category.split(","),n="",w=0,v=q.length;w<v;++w)-1===f.indexOf(q[w])&&f.push(q[w]),n+=" tb"+Themify.hash(q[w]);if(void 0===a[l].thumbnail||""===a[l].thumbnail)a[l].thumbnail="https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(a[l].title)+
"&w=181&h=77";k+='<div class="predesigned_row'+n+'" data-slug="'+a[l].slug+'"><figure class="tb_predesigned_rows_list_image">';k+='<img alt="'+a[l].title+'" title="'+a[l].title+'" src="'+a[l].thumbnail+'" /></figure>';k+='<div class="tb_predesigned_rows_list_title">'+a[l].title+"</div></div>"}a=null;f.sort();f.unshift("Empty Rows");l=0;for(m=f.length;l<m;++l)a="Empty Rows"!=f[l]?Themify.hash(f[l]):"-empty-rows",h+='<li><a href="#" data-slug="'+a+'">'+f[l]+"</li>";c.toolbar.$el.find(".tb_row_filter")[0].insertAdjacentHTML("beforeend",
...
b+".txt").done(function(a){d.rows[b]=a;"function"===typeof c&&c(a)}).fail(function(a,b,c){ThemifyBuilderCommon.showLoader("error");alert("Failed to fetch row template")})}},filter:function(){function a(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var b=a.data("slug"),g=a.closest(".tb_modules_panel_wrap"),f=g.find(".tb_row_filter_active"),h=g.find(".predesigned_row");f.text(a.text());g.find(".tb_module_panel_search_text").val("");if(b){var k="tb"+b;h.each(function(){e(this).hasClass(k)?
e(this).show():e(this).hide()})}else h.show();"tb_module_panel"===g.prop("id")?this.filter_toolbar=k:c.toolbar.common.filter_btn=k}c.toolbar.$el.find(".tb_row_filter").on("click","a",a.bind(this));setTimeout(function(){c.toolbar.common.btn.find(".tb_row_filter").on("click","a",a.bind(this))},100)}},common:{btn:null,clicked:null,filter_btn:null,preDesign_load:!1,library_load:!1,subTab_btn:"",init:function(){this.btn=e('<div class="tb_modules_panel_wrap" id="tb_plus_btn_popover"></div>');e(".edit-post-layout__content").length?
e(".edit-post-layout__content").append(this.btn):e("body").append(this.btn);var a=this;this.btn.on("click",".add_module_btn",function(b){c.toolbar.Panel.add_module(b,a.clicked.closest(".module_row").find(".themify_module_holder").last());a.clicked=null;a.btn.hide()}).on("keyup",".tb_module_panel_search_text",this.search.bind(this));c.toolbar.$el.find(".tb_module_panel_search_text").on("keyup",this.search.bind(this));if("visual"===c.mode)c.toolbar.$el.find(".tb_module_types a").on("click",this.tabs.bind(this));
e("body").on("click",".tb_module_types a",this.tabs.bind(this)).on("click",".tb_row_btn_plus",this.show.bind(this));e(document).on("update:tb_btn",this.btnData.bind(this));this.firstRun()},firstRun:function(){var a=c.toolbar.$el.find("#tb_module_panel");this.btn[0].insertAdjacentHTML("beforeend",a[0].innerHTML);this.btn.find(".tb_module_panel_lock").remove();this.btn.find(".themify_builder_module_outer").show();this.btn.find(".tb_module_panel_search_text").val("");new SimpleBar(this.btn.find(".tb_module_panel_modules_wrap")[0]);
c.Mixins.Builder.initModuleDraggable(this.btn)},btnData:function(a,b,d){a=c.toolbar.$el.find("."+b);this.btn.find("."+b).html(a.html());this.btn.find(".tb_module_panel_lock").remove();this.btn.find(".themify_builder_module_outer").show();this.btn.find(".tb_module_panel_search_text").val("");"visual"===c.mode?(c.Mixins.Builder.initRowVisualDrag(),c.Mixins.Builder.initRowGridVisualDrag(),c.Mixins.Builder.initModuleVisualDrag()):(c.Mixins.Builder.initRowDraggable(c.toolbar.$el),c.Mixins.Builder.initGridsDraggable(c.toolbar.$el),
c.Mixins.Builder.initModuleDraggable(c.toolbar.$el));c.toolbar.libraryItems.set_subTab("btn");new SimpleBar(this.btn.find("."+b)[0]);c.Mixins.Builder.initModuleDraggable(this.btn);c.Mixins.Builder.initRowDraggable(this.btn);c.Mixins.Builder.initGridsDraggable(this.btn);"function"===typeof d&&d()},tabs:function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var b=a.data("target"),c=a.closest(".tb_modules_panel_wrap");e(document).trigger("change:tab:"+b,c);c.find("."+b).show().siblings(".tb_module_panel_tab").hide();
a.closest("li").addClass("active").siblings().removeClass("active");c.find(".tb_module_panel_search_text").val("")},show:function(a){function b(){"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(e("body",top_iframe).height(document.body.scrollHeight+d.btn.outerHeight(!0)),e("body").css("padding-bottom",180))}a.preventDefault();a.stopPropagation();var d=this;this.clicked=e(a.currentTarget);a=this.clicked.offset();if(e(".edit-post-layout__content").length){var g=e(".edit-post-layout__content");a.top+=
g.scrollTop()-70;a.left=g.width()/2-11}this.btn.css({top:a.top,left:a.left-this.btn.width()/2+11}).show();a=(a=this.btn.find(".tb_module_types .active a").data("target"))?a:c.toolbar.$el.find(".tb_module_types .active a").data("target");e(document).trigger("change:tab:"+a,this.btn,b);null!==this.is_init&&b();this.hide()},hide:function(){function a(d){b.btn.is(":hover")||(b.btn.hide(),b.clicked=null,e(document).off("click",a),e(top_iframe).off("click",a),"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&
(e("body",top_iframe).height(document.body.scrollHeight),e("body").css("padding-bottom","")))}var b=this;if("visual"===c.mode)e(top_iframe).on("click",a);e(document).on("click",a)},search:function(a){a=e(a.currentTarget);var b=a.closest(".tb_modules_panel_wrap"),d="tb_module_panel_modules_wrap"===b.find(".tb_module_types .active a").data("target"),g="tb_module_panel_library_wrap"===b.find(".tb_module_types .active a").data("target"),f="tb_module_panel_rows_wrap"===b.find(".tb_module_types .active a").data("target"),
h=d||g||!c.toolbar.preDesignedRows.is_init?!1:"tb_module_panel"===b.prop("id")?c.toolbar.preDesignedRows.filter_toolbar:this.filter_btn,k=d||f||!c.toolbar.libraryItems.is_init?!1:"tb_module_panel"===b.prop("id")?c.toolbar.libraryItems.subTab_toolbar:this.subTab_btn,b=d?b.find(".themify_builder_module_outer"):c.toolbar.preDesignedRows.is_init&&!g?b.find(".predesigned_row"):c.toolbar.libraryItems.is_init&&g?b.find(".dragable_library_item"):!1;a=e.trim(a.val());if(!1!==b){var l=""===a,m=l?!1:new RegExp(a,
"i");b.each(function(){if(h&&!e(this).hasClass(h)||g&&!e(this).hasClass("dragable_library_item_"+k))return!0;var a=d?e(this).find(".module_name"):g?e(this).find(".dragable_library_item_inner span"):e(this).find(".tb_predesigned_rows_list_title");l||m.test(a.text())?e(this).show():e(this).hide()})}}},breakpointSwitcher:function(a){function b(){g.responsive_grids(f,l);e("body").trigger("themify_builder_change_mode",[l,f]);"visual"===c.mode?(m.css("will-change","auto"),c.Mixins.Builder.updateModuleSort(null,
"desktop"===f?"enable":"disable"),c.Utils._onResize(!0,function(){g.iframeScroll("desktop"!==f);e("body",top_iframe).height("desktop"!==f?document.body.scrollHeight:"auto");c.scrollTo&&setTimeout(function(){c.scrollTo&&e(window).add(top_iframe).scrollTop(c.scrollTo.offset().top);c.scrollTo=!1},500);setTimeout(function(){c.Utils.setCompactMode(document.getElementsByClassName("module_column"));k.removeClass("tb_start_animate")},200)})):k.removeClass("tb_start_animate");k.toggleClass("tb_responsive_mode",
"desktop"!==f).removeClass("builder-breakpoint-"+l).addClass("builder-breakpoint-"+f)}a.preventDefault();if(themifyBuilder.is_premium){var d="",g=this,f="desktop",h=e(a.currentTarget),k=e("body",top_iframe),l=c.activeBreakPoint;h.hasClass("breakpoint-tablet")?f="tablet":h.hasClass("breakpoint-tablet_landscape")?f="tablet_landscape":h.hasClass("breakpoint-mobile")&&(f="mobile");if(l===f&&void 0!==a.originalEvent)return!1;c.activeBreakPoint=f;"visual"===c.mode&&(k=k.add("body"));k.addClass("tb_start_animate");
"desktop"!==f&&(d=c.Utils.getBPWidth(f)-1);if("visual"===c.mode){var m=e("#themify_builder_site_canvas_iframe",top_iframe);e(".tb_toolbar_zoom_menu",top_iframe).removeClass("tb_toolbar_zoom_active").find(".tb_toolbar_zoom_menu_toggle").data("zoom",100);d="tablet_landscape"===f&&ThemifyBuilderCommon.Lightbox.dockMode.get()&&e(".themify_builder_workspace_container",top_iframe).width()<d?e(".themify_builder_workspace_container",top_iframe).width():d;c.isPreview&&(a={tablet_landscape:1024,tablet:768,
mobile:375},f in a&&(d=a[f]));m.css("width",d).parent().removeClass("themify_builder_zoom_bg");try{if(d&&m.width()!=d)m.css("will-change","width").one(c.Utils.transitionPrefix(),b);else b()}catch(q){m.css("width",e(".themify_builder_workspace_container",top_iframe).width())}}else b()}},iframeScroll:function(a){var b=e(top_iframe);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){window.scrollTo(0,e(this).scrollTop())})},responsive_grids:function(a,b){for(var c=
document.querySelectorAll(".row_inner,.subrow_inner"),g="desktop"===a,f=g||"desktop"===b,h=0,k=c.length;h<k;++h){var l=c[h].getAttribute("data-basecol");if(l){var m=c[h].children,q=c[h].dataset["col_"+a],n=m[0],w=m[m.length-1];if(!g){if("desktop"!==b){c[h].classList.remove("tb_3col");var v=c[h].getAttribute("data-col_"+b);v&&c[h].classList.remove(e.trim(v.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(q&&"-auto"!==q){if(q=c[h].getAttribute("data-col_"+a)){c[h].classList.add("tb_grid_classes");
c[h].classList.add("col-count-"+l);var q=q.split(" "),p;for(p in q)c[h].classList.add(e.trim(q[p].replace("mobile","column").replace("tablet","column")))}}else c[h].classList.remove("tb_grid_classes"),c[h].classList.remove("col-count-"+l)}if(f)for(l=0,q=m.length;l<q;++l)v=e(m[l]).data("w"),void 0!==v&&(m[l].style.width=g?v+"%":"");"rtl"===c[h].getAttribute("data-"+a+"_dir")?(n.classList.remove("first"),n.classList.add("last"),w.classList.remove("last"),w.classList.add("first"),c[h].classList.add("direction-rtl")):
(n.classList.remove("last"),n.classList.add("first"),w.classList.remove("first"),w.classList.add("last"),c[h].classList.remove("direction-rtl"))}}},Panel:{el:null,is_locked:!1,key:"tb_module_panel_locked",init:function(){this.el=c.toolbar.$el.find(".tb_toolbar_add_modules_wrap");this.el.blur().hover(this.toogle.bind(this)).find(".tb_module_panel_lock").on("click",this.lock.bind(this));this._setupModulePanelState();this.el.find(".add_module_btn").on("click",this.add_module)},add_module:function(a,
b){a.preventDefault();a.stopPropagation();b=b||c.Instances.Builder[0].$el.find(".module_row").last().find(".themify_module_holder").first();var d=b.offset().top-37;"visual"===c.mode?"desktop"!==c.activeBreakPoint&&e(top_iframe).scrollTop(d):d-=50;e(window).scrollTop(d);c.Mixins.Builder.moduleDrop(e(a.currentTarget).closest(".themify_builder_module"),b)},resetPanel:function(){this.el.removeClass("tb_disabled");this.is_locked&&this.toggleLock()},toogle:function(a){this.is_locked||this.el.hasClass("tb_disabled")||
(e(a.currentTarget).focus(),"tb_module_panel_library_wrap"==c.toolbar.$el.find("ul.tb_module_types li.active a").data("target")&&e(document).trigger("change:tab:tb_module_panel_library_wrap",c.toolbar.$el.find("#tb_module_panel.tb_modules_panel_wrap")))},lock:function(a){a.preventDefault();this.is_locked=!this.is_locked;localStorage.setItem(this.key,this.is_locked);this.toggleLock();if(!this.is_locked){this.el.addClass("tb_hide_panel");var b=this;setTimeout(function(){c.toolbar.$el.find("#themify_builder_switch_backend").focus();
b.el.removeClass("tb_hide_panel")},1E3)}},toggleLock:function(){var a=c.toolbar.$el;"visual"===c.mode&&(a=a.add(e("body")),a.addClass("tb_remove_transitions"));e("body",top_iframe).toggleClass("tb_module_panel_locked");e(window).trigger("tfsmartresize");a.removeClass("tb_remove_transitions")},_setupModulePanelState:function(){this.is_locked=localStorage.getItem(this.key);"false"===this.is_locked&&(this.is_locked=!1);this.is_locked&&setTimeout(this.toggleLock,1200)},hide:function(){this.el.blur();
if(this.is_locked){this.el.removeClass("tb_disabled");var a=c.toolbar.$el;"visual"===c.mode&&(a=a.add(e("body")),a.addClass("tb_remove_transitions"));e("body",top_iframe).removeClass("tb_module_panel_locked");e(window).trigger("tfsmartresize");a.removeClass("tb_remove_transitions")}this.el.addClass("tb_disabled")},show:function(){this.is_locked||this.el.focus()}},toggleFavoriteModule:function(){var a=e(this),b=a.closest(".themify_builder_module_outer"),d=a.parent().data("module-slug");e.ajax({type:"POST",
url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_module_favorite",module_name:d,module_state:+!b.hasClass("favorited")},beforeSend:function(a){function g(a,b){function f(){a.removeAttr("style");if(b){var f=0<a.closest("#tb_plus_btn_popover").length?c.toolbar.$el:e("#tb_plus_btn_popover");g(f.find(".module-type-"+d).closest(".themify_builder_module_outer"),!1)}}if(a.is(":visible"))a.css({opacity:0,transform:"scale(0.5)"}).one(h,function(){a.toggleClass("favorited").css({opacity:1,transform:"scale(1)"}).one(h,
f)});else a.toggleClass("favorited"),f()}var h=c.Utils.transitionPrefix();g(b,!0)}})},zoom:function(a){function b(){c.Utils._onResize(!0)}a.preventDefault();if("desktop"!==c.activeBreakPoint)return!0;var d=e(a.currentTarget);a=d.data("zoom");var g=e(".themify_builder_site_canvas_iframe",top_iframe),f=d.closest(".tb_toolbar_zoom_menu");d.hasClass("tb_toolbar_zoom_menu_toggle")?(a="100"==a?50:100,d.data("zoom",a),d=d.next("ul").find('[data-zoom="'+a+'"]')):f.find(".tb_toolbar_zoom_menu_toggle").data("zoom",
